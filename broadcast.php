...
<nav>
   ...
   <a href="broadcast/boxing.php"><div id='btn'> Watch now</div> </a> 
    ...
    <!-- ======= Footer ======= -->
    <footer style="background-color: #dc2626;margin-top:50px; padding: 20px 30px;display:grid;grid-template-columns:2fr 1fr 1fr;gap-30px;justify-content:center;color:white">
        <div>
